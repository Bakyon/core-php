            ...
            <form action="#" method="post" enctype="multipart/form-data">
                <div class="col-xl-12">
                    ...
                    <div class="container col-xl-4 col-xs-12" style="float: left; padding: 25px;">
                        <div class="container col-xs-12 mail_sectin">
                            ...
                            <div class="input-group-text">
                                ...
                                <input type="text" class="email-bt" readonly value="<?= $data['user']->getGender() ?>" name="gender" size="28" aria-required="true">
                            </div><br>
                            <div class="input-group-text">
                                <label for="bỉthdate" style="margin: 0; width: 30%;"><b>Birthday</b></label>
                                <input type="date" class="email-bt" readonly value="<?= $data['user']->getBirthday() ?>" name="birthdate" size="28" aria-required="true">
                            </div><br>
                        </div>
                    </div>
                    ...
                    <div class="container col-xl-4 col-xs-12"  style="float: left; padding: 25px;">
                        ...
                        <a href="?cont=user" class="btn btn-secondary" style="width: 200px;margin: 0 0 10px 30px;">Go back</a>
                    </div>
